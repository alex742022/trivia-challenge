...
//condition to not repeat a number generated by Math.random number
    while (currentQuestionsIndex[currentQuestionsIndex.length - 1]){
     randomIndex =  randomIndex = Math.floor(Math.random() * results.length);
    }
  ...
  return currentQuestionsIndex + 1 === results.length ? (
    <ShowResults
      showResults={score}
    ...
    <div className="max-w-[800px] mx-auto bg-white px-[15px] sm:px-[40px] py-[30px] mt-[100px]">
      <div className="flex justify-between items-center">
        ...
        <small className="text-[15px] sm:text-[20px]">
          {currentQuestionsIndex.length + 1} of {results.length}
        </small>
      </div>
